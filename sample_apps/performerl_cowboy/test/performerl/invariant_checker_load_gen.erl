-module(invariant_checker_load_gen).
...
-export([start_load/2, stop_load/1, get_load_duration/0,
         ...
         get_test_name/0, get_invariants/2]).

%%====================================================================
%% API functions
%%====================================================================

get_test_name() -> "Response Benchmark with Invariant Checking".
...
get_invariants(_TestNode, TestSize) ->
    [
        {invariant1, {random, uniform, [10]}, '>=', 5},
        {memory_invariant, {erlang, memory, [total]}, '=<', TestSize*1024*1024}
    ].
